    ...
    return (
        <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5 bg-white dark:bg-gray-800">
            ...
            <dialog id="edit" className="modal">
                <div className="modal-box bg-gray-800 border border-gray-700 rounded-lg p-5">
                    <h3 className="font-bold text-xl text-yellow-400">Edit Address</h3>
                    ...
                    {isLoading ? (
                        ...
                        <div>
                            <div className="mb-4">
                                <label htmlFor="buildingNo" className="block text-gray-300 m-1">Building No:</label>
                                <input
                                    type="text"
                                    ...
                                    name="buildingNo"
                                    className="input w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-gray-300"
                                />
                            </div>
                            <div className="mb-4">
                            ...
                            <div className="mb-4">
                                <label htmlFor="pincode" className="block text-gray-300">Pincode:</label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label htmlFor="gst" className="block text-gray-300">GST No:</label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label htmlFor="logo" className="block text-gray-300">Logo:</label>
                                <input
                                    type="file"
                                    onChange={e => setAddressData({ ...addressData, logo: e.target.files[0] })}
                                    id="logo"
                                    name="logo"
                                    className="file-input file-input-bordered file-input-warning w-full text-gray-300 bg-gray-700 border border-gray-600 rounded-lg"
                                />
                            </div>
                            <button onClick={e => {
            ...
            <dialog id="editTax" className="modal">
                <div className="modal-box bg-yellow-50 dark:bg-gray-800 border border-yellow-200 rounded-lg">
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            <label htmlFor="city" className="block text-gray-700 dark:text-light-golden">Percent Of Tax</label>
                            <input type="text"
