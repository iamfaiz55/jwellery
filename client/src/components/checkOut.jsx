            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-light-golden dark:bg-gray-900"> {/* Changed background to a darker shade */}
                ...
                <div className="md:col-span-2 bg-light-golden dark:bg-gray-800 p-4 space-y-8 mb-20 md:mb-0 rounded-lg"> {/* Darker background for desktop */}
                    ...
                    {isError ? (
                        ...
                        <>
                            <button className="btn bg-yellow-500 text-black hover:bg-yellow-600 z-1" onClick={() => document.getElementById('add').showModal()}>
                                Add Address
                            </button>
                            ...
                            <button onClick={handlePayNow} className="submit-button px-4 py-3 rounded-full bg-yellow-500 text-white w-full text-xl font-semibold transition-colors hover:bg-yellow-600 mt-4">
                                Pay Now
                            </button>
                        </>
                    )}
