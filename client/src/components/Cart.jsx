        ...
        <div className="min-h-screen  pt-20">
            ...
            <div className="mx-auto max-w-5xl px-6 md:flex md:space-x-6 xl:px-0">
                ...
                <div className="mt-6 rounded-lg bg-white p-6 shadow-xl md:mt-0 md:w-1/3">
                    ...
                    }} className="mt-6 w-full rounded-md bg-pink-500 py-2 text-lg font-semibold text-white transition-transform duration-200 hover:scale-105 hover:bg-pink-600">
                        Proceed to Checkout
                    </button>
                </div>
            </div>
