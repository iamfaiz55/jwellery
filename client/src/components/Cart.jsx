                                ...
                                <div className="mx-auto max-w-5xl px-6 md:flex md:space-x-6 xl:px-0 ">
                                                    ...
                                                    <div className="sm:flex sm:justify-between">
                                                        ...
                                                        <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                                            <div className="mt-5 sm:mt-0">
                                                                ...
                                                                <p className="dark:text-gray-400">Price: ₹{variant.price}</p>
                                                                ...
                                                                <div className="flex items-center space-x-4">
                                                                    ...
                                                                    <button onClick={() => deleteItem(item._id)}>
                                                                        <svg
                                                                            ...
                                                                            strokeWidth="1.5"
                                                                            stroke="currentColor"
                                                                            className="h-6 w-6 cursor-pointer dark:text-gray-200 transition-colors duration-200 hover:text-red-500"
                                                                        >
                                    ...
                                    <div className="mt-6  rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl md:mt-0 md:w-1/3">
                                        ...
                                        <div className="flex justify-between border-b py-4">
                                            ...
                                            <p className="text-lg font-semibold dark:text-white">₹{totalWithTaxAndCharges.toFixed(2)}</p>
                                        </div>
                                        <button onClick={() => {
