    ...
    return (
        <>
            ...
            <div className="btm-nav z-20 fixed bottom-0 w-full bg-light-golden dark:bg-gray-800 text-white flex justify-around py-3 sm:hidden">
                <Link to="/" className="focus:outline-none text-golden dark:text-dark-golden hover:text-yellow-300 dark:hover:text-yellow-400">
                    <svg
                ...
                <Link to='/user/profile'>
                    <button className="focus:outline-none text-golden dark:text-dark-golden hover:text-yellow-300 dark:hover:text-yellow-400">
                        <svg
                            className='h-8 w-8'
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 64 64"
